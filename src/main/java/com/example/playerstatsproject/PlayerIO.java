...
public class PlayerIO {
    private static final String INPUT_FILE_NAME = "C:\\PlayerStatsProject\\src\\main\\java\\com\\example\\playerstatsproject\\players.txt";
    private static final String OUTPUT_FILE_NAME = "C:\\PlayerStatsProject\\src\\main\\java\\com\\example\\playerstatsproject\\players.txt";

     static void READ(List<Player> PlayerList) throws Exception{
     ...
     static void WRITE(List<Player> PlayerList) throws Exception{
